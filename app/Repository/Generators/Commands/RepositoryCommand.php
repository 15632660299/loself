...
namespace App\Repository\Generators\Commands;

use Illuminate\Console\Command;
use Illuminate\Support\Collection;
use App\Repository\Generators\FileAlreadyExistsException;
use App\Repository\Generators\MigrationGenerator;
use App\Repository\Generators\ModelGenerator;
use App\Repository\Generators\RepositoryEloquentGenerator;
use App\Repository\Generators\RepositoryInterfaceGenerator;
...
class RepositoryCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'server:repository';
