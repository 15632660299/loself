...
class ExaminationsController extends BaseController
{
    ...
    /**
     * @var ExaminationValidator
     */
    protected $validator;

    public function __construct(ExaminationRepository $repository, ExaminationValidator $validator)
    {
     ...
     *
     * @param  ExaminationCreateRequest $request
     *
    ...
    public function store(ExaminationCreateRequest $request)
    {
        ...
        $examination = $this->repository->create($request->all());
...
//        throw new StoreResourceFailedException('Failed to Create.');
     ...
     *
     * @param  ExaminationUpdateRequest $request
     * @param  string            $id
     *
     * @return \Dingo\Api\Http\Response
     */
    public function update(ExaminationUpdateRequest $request, $id)
    {
        ...
        $examination = $this->repository->update($request->all(), $id);
